...
const temperaturesCelsius: number[] = [15, 23, 18, 27, 30, 25, 19, 22, 28, 16, 20, 24, 21, 29, 17];
...
const temperaturesFahrenheit: number[] = temperaturesCelsius.map(celsiusToFahrenheit);
